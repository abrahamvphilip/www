			...
			<div className="loaderMain">
				...
				>
					...
					<path
						...
						style={{
							fill: "var(--eucalyptus-675)",
							stroke: "var(--eucalyptus-325)",
						}}
					/>
					{/* Bottom tier - right shadow */}
					<path
						d="M40 79L72 60V70.4001C72 71.1151 71.6183 71.7758 70.9987 72.1329L40 90V79Z"
						style={{ fill: "var(--eucalyptus-675)" }}
					/>
					{/* Bottom tier - left shadow */}
					<path
						d="M34 79L3 61V71.5751L34 90V79Z"
						style={{ fill: "var(--eucalyptus-425)" }}
					/>
					{/* Strobe lights - bottom tier */}
					<path
						d="M58 72.5L60.5 71V74L58 75.5V72.5Z"
						style={{ fill: "var(--orange-roughy-225)" }}
					/>
					<path
						d="M63 69.5L65.5 68V71L63 72.5V69.5Z"
						className="loaderStrobeGreen"
						style={{ fill: "var(--eucalyptus-225)" }}
					/>
					<path
