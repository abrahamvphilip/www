...
import nexusFeature1 from "@/../public/nexusFeatures/1.png";
import nexusFeature2 from "@/../public/nexusFeatures/2.png";
import nexusFeature3 from "@/../public/nexusFeatures/3.png";
import nexusFeature4 from "@/../public/nexusFeatures/4.png";
...
export function NexusFeatures() {
	...
	const maxTranslate = Math.max(
		0,
		cardWidth * FEATURE_CARDS.length - containerWidth,
	);
...
function FeatureCard({ feature }: { feature: FeatureCard }) {
	return (
		<div className="flex w-[772px] shrink-0 flex-col gap-6 p-5 tablet:w-[600px] max-tablet:w-[calc(100vw-32px)] max-tablet:gap-4 max-tablet:p-0">
			...
			<RevealImage
				src={feature.image}
				alt={`aion Nexus feature: ${feature.title}`}
				fill
