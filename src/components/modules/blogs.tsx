...
function ResourceCard({
	...
	return (
		<article className="flex w-[421px] shrink-0 flex-col gap-0.5 rounded-lg border border-(--bunker-800)/4 bg-(--gallery-25) p-0.5">
			<div className="relative h-[252px] w-full overflow-hidden rounded-[6px]">
...
export function Blogs() {
	...
	return (
		<Segment className="pt-14! pb-[144px]!">
			<Container as="div" className="flex flex-col gap-14 px-10!">
				{/* Header */}
				<div className="flex items-end gap-3">
					<div className="flex w-[565px] shrink-0 flex-col gap-3">
					...
					<div className="flex flex-1 items-start justify-end pt-3">
						<a
							href="/resources"
				...
				{/* Lead article row */}
				<div className="flex h-[445px] gap-3">
					<div className="relative h-full w-[854px] shrink-0 overflow-hidden rounded-lg bg-(--gallery-100)">
						{/*
							<Image
								src={leadImage}
								alt=""
					...
					<div className="flex min-w-0 flex-1 flex-col justify-between">
						<div className="px-2">
							...
							<div className="flex w-[710px] flex-col gap-1 py-5">
