...
export function NexusSection({ nexus }: NexusSectionProps) {
  return (
    <section data-section-id="X6Q8j" className="overflow-hidden bg-[var(--surface-dark-forest)] lg:h-[1974px]">
      <div className="site-shell">
        <div className="grid gap-10 px-4 pb-10 pt-20 lg:h-[1014px] lg:grid-cols-[854px_854px] lg:justify-between lg:gap-3 lg:px-10 lg:pb-10 lg:pt-[120px]">
          <div className="relative h-[854px] w-full">
            <PlaceholderMedia label="nexus-diagram" ratio="854 / 854" className="bg-[var(--surface-primary)]" />
            <div className="absolute left-[194px] top-[328px] w-[113px] rounded-[2px] border border-[#141413] bg-[#fafafa] px-2 py-1 text-[#141413]">
              <p className="text-[7.8993px] leading-[1.3]">{nexus.stackLabels[0]}</p>
            </div>
            <div className="absolute left-[216px] top-[151px] w-[136px] rounded-[2px] border border-[#141413] bg-[#fafafa] px-2 py-1 text-[#141413]">
              <p className="text-[7.8993px] leading-[1.3]">{nexus.stackLabels[1]}</p>
            </div>
          </div>
          ...
          <div className="flex min-h-[854px] flex-col justify-between gap-10">
            <div className="w-full space-y-6">
              <div className="space-y-3 pt-20">
                <p className="font-sans text-[12px] font-medium leading-[1.3333333333] tracking-[0.5px] text-[var(--text-subtle)]">{nexus.header.eyebrow}</p>
            ...
            <div className="flex flex-wrap items-center gap-6 pb-16">
              <PillButton label={nexus.ctas[0]} href="/nexus" badge="2" className="w-[170px]" />
              <div className="flex h-[38px] w-[216px] items-center">
                <PillButton label={nexus.ctas[1]} href="/platform" dark badge="2" className="w-[170px]" />
        ...
        <div className="space-y-[56px] overflow-hidden px-4 pb-[200px] pt-0 lg:h-[960px] lg:px-10">
          <div className="flex items-center justify-between gap-4">
            ...
            <PillButton label="1/4" href="/nexus/step" dark badge="2" className="h-[36px] w-[47px] px-3" />
          </div>
